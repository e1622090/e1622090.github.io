...
*/
const problems = {
    R: ["R1", "R2", "R3","R4_1","R5","R6","R7","R8","R9","R10","R11"],        // 来客対応
    P: ["P1", "P2","P3","P4_1","P5","P6","P7","P8","P9","P10","P11"],        // 電話対応
    T: ["T1", "T2","T3","T4","T5","T6","T7","T8","T9","T10"],        // 先方訪問
    random: ["R1","R2","R3","R4_1","R5","R6","R7","R8","R9","R10","R11","P1","P2","P3","P4_1","P5","P6","P7","P8","P9","P10","P11","T1","T2","T3","T4","T5","T6","T7","T8","T9","T10"]
};
...
今後ともどうぞよろしくお願いいたします。`
    ...
    R11: {
        ...
        example:
`【正しい解答例】
申し訳ございませんが、社長はただいま外出しております。
待合室にご案内いたしますので、恐れ入りますが、そちらでお待ちいただけますでしょうか。`
    },
...
担当者より改めてご連絡を差し上げてもよろしいでしょうか。`
    ...
    P11: {
        ...
        polite: ["です", "ます", "ござい", "おり","いただ"],
        // クッション言葉：判定する
        cushion: ["恐れ入", "お手数", "お忙しい","今しばらく","いま、しばらく"],

        successMessage: "正解です！",
        example:
`【正しい解答例】
恐れ入りますが、部署名などお分かりでしたらお教えいただけますか。`
    },
